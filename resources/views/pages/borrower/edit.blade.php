...
@include('inc.alert')
<div class="container">
    <h1 class="text-decoration-underline">Edit Peminjam</p></h1>
    ...
    <div class="border border-dark mt-3 p-3">
        <form action="{{ route('borrower.update', ['id'=>request()->route('id')]) }}" method="POST">
            ...
            <div class="mb-3">
                <label for="created_at" class="form-label">Tanggal Pinjam</label>
                <input type="date" name="created_at" class="form-control" id="created_at" value="{{ $borrower->created_at}}" required>
            ...
            <div class="mb-3">
                <label for="item_id" class="form-label">Nama dan No Serial Barang</label>
